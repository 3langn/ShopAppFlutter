...
/// and [CustomSearchDelegate.buildActions]. Additonally, a widget can be placed
...
class DataSearch extends CustomSearchDelegate<String> {
  ...
  final List<Product> recentCities = [
    Product(id: '', title: 'Bag', description: 'b', price: 1.0, imageUrl: ''),
    Product(id: '', title: 'Bed', description: 'b', price: 1.0, imageUrl: ''),
    Product(id: '', title: 'Shoe', description: 'b', price: 1.0, imageUrl: ''),
    Product(id: '', title: 'Bag', description: 'b', price: 1.0, imageUrl: ''),
    Product(id: '', title: 'Bed', description: 'b', price: 1.0, imageUrl: ''),
    Product(id: '', title: 'Shoe', description: 'b', price: 1.0, imageUrl: ''),
  ];
  ...
  Widget buildSuggestions(BuildContext context) {
    final searchProduct =
        Provider.of<Products>(context, listen: false).searchProduct(query);
    final suggestionList = query.isEmpty ? recentCities : searchProduct;
